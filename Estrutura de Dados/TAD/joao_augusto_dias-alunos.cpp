/* 
    ...
    Solução de: JOAO AUGUSTO DIAS NETO
*/
...
class turma {
    ...
    public:
        ...
        turma(const turma &maisCapacidade);
        ~turma();
...
turma::turma(const turma &maisCapacidade) {
	capacidadeMaxima = maisCapacidade.capacidadeMaxima;
    quantidadeDeAlunos = maisCapacidade.quantidadeDeAlunos;
    listaDeAlunos = new aluno[capacidadeMaxima];
    copy(maisCapacidade.listaDeAlunos, maisCapacidade.listaDeAlunos+quantidadeDeAlunos, listaDeAlunos);
}
turma::~turma() {
...
void turma::redimensionarCapacidade() {
    capacidadeMaxima += ceil(capacidadeMaxima * 0.5);
	aluno* maisCapacidade;
    maisCapacidade = new aluno[capacidadeMaxima];
    copy(listaDeAlunos, listaDeAlunos+quantidadeDeAlunos, maisCapacidade);
    delete[] listaDeAlunos;
    listaDeAlunos = maisCapacidade;
}
